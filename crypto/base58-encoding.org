...
- [[#testing-and-usage][Testing and usage]]
  ...
  - [[#using-the-base58-encode-and-decode-cli-commands][Using the base58 encode and decode CLI commands]]
  - [[#using-the-base58chk-encode-and-decode-cli-commands][Using the base58chk encode and decode CLI commands]]
:END:
...
*** Using the =base58= =encode= and =decode= CLI commands
...
*** Using the =base58chk= =encode= and =decode= CLI commands
